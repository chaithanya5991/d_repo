	...
	<div class="wrap">
		...
		<div class="content">
			<div class="inner-page">
				...
				<div class="container" style="margin-top:-80px; clear:both">
					<div class="row">
						<div class="col-md-6" >
								<br><br><br><br>
    ...
    <div class="carousel-inner" style="height:725px;">
      <div class="item active">
			 ...
			 foreach ($single as $value) {
				?>
				<img src="<?php echo base_url();?>/uploads/<?php echo $value->dimage1;?> " alt ="<?php echo $value->dimage1;?>" width='80%' height='80%'>
			</div>
		<?php } ?>
      <div class="item">
				<?php
			 foreach ($single as $value) {
		?>
				<img src="<?php echo base_url();?>/uploads/<?php echo $value->dimage2;?> " alt ="<?php echo $value->dimage2;?>" width='80%' height='80%'>
			</div>
		<?php } ?>
      <div class="item">
				<?php
			 foreach ($single as $value) {
				?>
				<img src="<?php echo base_url();?>/uploads/<?php echo $value->dimage3;?> " alt ="<?php echo $value->dimage3;?>" width='80%' height='80%'>
			</div>
		<?php } ?>
</div>
