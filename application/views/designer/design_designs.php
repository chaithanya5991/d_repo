					...
					<div class="grid">
						...
						<div class="grid-info">
							...
							<div class="lables">
								...
								<center><a href="<?php echo base_url('index.php/designerctrl/sale_delete/'.$id);?>" type="button"  class="glyphicon glyphicon-trash" style="color:red;font-size:20px " onclick="return confirm
